...
from paths import network_training_output_dir, default_plans_identifier
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
    ...
    trainer_path = join(orgin_path, "training", "network_training")
    trainer_class = recursive_find_python_class([trainer_path], network_trainer,
                                                current_module=base_module)
