...
def main():
    ...
    parser.add_argument("-network_trainer", required=False, default='HasTrainer_DP_CADD_3kid')
    parser.add_argument("-task", help="can be task name or task id", required=False, default='Task310_Urinary')
    parser.add_argument("-fold", help='0, 1, ..., 5 or \'all\'', required=False, default=4)
    parser.add_argument("-val", "--validation_only", help="use this if you want to only run the validation",
                        action="store_true")
    parser.add_argument("-c", "--continue_training", help="use this if you want to continue a training",
                        action="store_true")
    parser.add_argument("-p", help="plans identifier. Only change this if you created a custom experiment planner",
                        default='nnUNetPlans_Double_DenseUNet_v2.1_2', required=False) # default_plans_identifier, required=False)
    ...
    parser.add_argument("-gpus", help="number of gpus", required=False, type=int, default=1)
