...
from training.network_training.nnUNet_variants.data_augmentation.nnUNetTrainerV2_DA3 import nnUNetTrainerV2_DA3

from utilities.nd_softmax import softmax_helper

class HasTrainer_DP_CADD(nnUNetTrainerV2_DA3): #nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=4, distribute_batch_size=False, fp16=False):
        super(HasTrainer_DP_CADD, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
...
nnUNetTrainerV2_ResencUNet_copy1 = HasTrainer_DP_CADD
nnUNetTrainerV2_ResencUNet_copy2 = HasTrainer_DP_CADD
nnUNetTrainerV2_ResencUNet_copy3 = HasTrainer_DP_CADD
nnUNetTrainerV2_ResencUNet_copy4 = HasTrainer_DP_CADD
