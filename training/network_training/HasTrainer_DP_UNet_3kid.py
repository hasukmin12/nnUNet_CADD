...
from nnunet.network_architecture.Has_UNet_DP import Has_UNet_DP
...
class HasTrainer_DP_UNet_3kid(nnUNetTrainerV2_DA3_for_3kid): #nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=4, distribute_batch_size=False, fp16=False):
        super(HasTrainer_DP_UNet_3kid, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
    ...
    def initialize_network(self):
        ...
        self.network = Has_UNet_DP(self.num_input_channels, self.base_num_features, blocks_per_stage_encoder, 2,
...
trainer = HasTrainer_DP_UNet_3kid
