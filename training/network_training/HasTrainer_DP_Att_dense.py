...
from network_architecture.generic_dense_UNet import get_default_network_config
from network_architecture.generic_Att_dense_UNet_DP import ATT_DenseUNet_DP
