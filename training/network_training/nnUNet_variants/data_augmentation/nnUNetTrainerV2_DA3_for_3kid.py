...
from training.data_augmentation.data_augmentation_insaneDA2 import get_insaneDA_augmentation2
...
from training.network_training.nnUNetTrainerV2_for_3kid import nnUNetTrainerV2_for_3kid, maybe_mkdir_p
from utilities.nd_softmax import softmax_helper
from torch import nn


class nnUNetTrainerV2_DA3_for_3kid(nnUNetTrainerV2_for_3kid):
    ...
    def initialize(self, training=True, force_load_plans=False):
        if not self.was_initialized:
            ...
            self.patch_size=np.array([240, 224, 32])
...
class nnUNetTrainerV2_DA3_BN(nnUNetTrainerV2_DA3_for_3kid):
