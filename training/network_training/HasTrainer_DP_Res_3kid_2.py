...
from nnunet.network_architecture.Has_ResUNet_DP import Has_ResUNet_DP
...
class HasTrainer_DP_Res_3kid_2(nnUNetTrainerV2_DA3_for_3kid): #nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=4, distribute_batch_size=False, fp16=False):
        super(HasTrainer_DP_Res_3kid_2, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
    ...
    def initialize_network(self):
        ...
        self.network = Has_ResUNet_DP(self.num_input_channels, self.base_num_features, blocks_per_stage_encoder, 2,
...
trainer = HasTrainer_DP_Res_3kid_2

nnUNetTrainerV2_ResencUNet_copy1 = trainer
nnUNetTrainerV2_ResencUNet_copy2 = trainer
nnUNetTrainerV2_ResencUNet_copy3 = trainer
nnUNetTrainerV2_ResencUNet_copy4 = trainer
