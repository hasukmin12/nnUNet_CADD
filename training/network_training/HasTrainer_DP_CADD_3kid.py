...
from network_architecture.DDense_UNet import get_default_network_config
from network_architecture.CA_MDD_UNet_DP import CA_MDD_UNet_DP
...
from training.network_training.nnUNet_variants.data_augmentation.nnUNetTrainerV2_DA3_for_3kid import nnUNetTrainerV2_DA3_for_3kid

from nnunet.utilities.nd_softmax import softmax_helper

class HasTrainer_DP_CADD_3kid(nnUNetTrainerV2_DA3_for_3kid): #nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=4, distribute_batch_size=False, fp16=False):
        super(HasTrainer_DP_CADD_3kid, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
...
nnUNetTrainerV2_ResencUNet_copy1 = HasTrainer_DP_CADD_3kid
nnUNetTrainerV2_ResencUNet_copy2 = HasTrainer_DP_CADD_3kid
nnUNetTrainerV2_ResencUNet_copy3 = HasTrainer_DP_CADD_3kid
nnUNetTrainerV2_ResencUNet_copy4 = HasTrainer_DP_CADD_3kid
