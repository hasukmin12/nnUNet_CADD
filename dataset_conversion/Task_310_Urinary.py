...
if __name__ == "__main__":
    ...
    base = "/vast/AI_team/sukmin/datasets/past_from_cv/CVLab_data/_has_Task280_Urinary"

    task_id = 310
    task_name = "Urinary"
    foldername = "Task%03.0d_%s" % (task_id, task_name)

    nnUNet_raw_data = '/vast/AI_team/sukmin/nnUNet_raw_data_base/nnUNet_raw_data'
