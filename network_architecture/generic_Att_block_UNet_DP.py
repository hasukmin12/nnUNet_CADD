...
import torch
from network_architecture.generic_Att_block_UNet import Att_DenseUNet
...
from network_architecture.custom_modules.conv_block_for_self_Att_block import DenseUpBlock, DenseUpLayer, DenseDownBlock_2, DenseDownLayer_2
