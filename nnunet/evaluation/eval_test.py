...
# folder_with_gt = '/data4/sukmin/nnUNet_raw_data_base/nnUNet_raw_data/Task250_Ureter/labelsTs'
folder_with_gt = '/data5/sukmin/nnUNet_raw_data_base/nnUNet_raw_data/Task275_Urinary/labelsTs'
...
folder_with_pred = '/data5/sukmin/inf_2_GT_275_Res_fc'
