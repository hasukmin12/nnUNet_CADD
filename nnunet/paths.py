...
base = '/vast/AI_team/sukmin/nnUNet_raw_data_base'
preprocessing_output_dir = '/vast/AI_team/sukmin/nnunet_process_out'
# network_training_output_dir_base = '/data5/sukmin/nnunet_train_out'
network_training_output_dir_base = '/vast/AI_team/sukmin/nnunet_train_out'
