...
class GS_CADD_UNet(SegmentationNetwork):
    """
    Residual Encoder, Plain conv decoder
    """
    use_this_for_2D_configuration = 1244233721.0  # 1167982592.0
...
def find_3d_configuration():
    ...
    blocks_per_stage_encoder = GS_CADD_UNet.default_blocks_per_stage_encoder
    blocks_per_stage_decoder = GS_CADD_UNet.default_blocks_per_stage_decoder
    ...
    unet = GS_CADD_UNet(num_modalities, initial_num_features, blocks_per_stage_encoder[:len(conv_op_kernel_sizes)], 2,
    ...
    print(GS_CADD_UNet.compute_approx_vram_consumption(patch_size, initial_num_features, max_num_features, num_modalities,
                                                num_classes, pool_op_kernel_sizes,
