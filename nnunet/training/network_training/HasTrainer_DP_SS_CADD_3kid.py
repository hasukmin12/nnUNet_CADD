...
from nnunet.network_architecture.SS_CADD_UNet_DP import SS_CADD_UNet_DP

from nnunet.network_architecture.initialization import InitWeights_He
from nnunet.training.network_training.nnUNetTrainer import nnUNetTrainer
from nnunet.training.network_training.nnUNetTrainerV2 import nnUNetTrainerV2
from nnunet.training.network_training.nnUNet_variants.data_augmentation.nnUNetTrainerV2_DA3_for_3kid import nnUNetTrainerV2_DA3_for_3kid

from nnunet.utilities.nd_softmax import softmax_helper

class HasTrainer_DP_SS_CADD_3kid(nnUNetTrainerV2_DA3_for_3kid): #nnUNetTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=4, distribute_batch_size=False, fp16=False):
        super(HasTrainer_DP_SS_CADD_3kid, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
    ...
    def initialize_network(self):
        ...
        self.network = SS_CADD_UNet_DP(self.num_input_channels, self.base_num_features, blocks_per_stage_encoder, 2,
...
nnUNetTrainerV2_ResencUNet_copy1 = HasTrainer_DP_SS_CADD_3kid
nnUNetTrainerV2_ResencUNet_copy2 = HasTrainer_DP_SS_CADD_3kid
nnUNetTrainerV2_ResencUNet_copy3 = HasTrainer_DP_SS_CADD_3kid
nnUNetTrainerV2_ResencUNet_copy4 = HasTrainer_DP_SS_CADD_3kid
