...
from nnunet.training.network_training.nnUNetTrainerV2_for_3kid import nnUNetTrainerV2_for_3kid
...
class nnUNetTrainerV2_3kid_DP(nnUNetTrainerV2_DA3_for_3kid):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, num_gpus=1, distribute_batch_size=False, fp16=False):
        super(nnUNetTrainerV2_3kid_DP, self).__init__(plans_file, fold, output_folder, dataset_directory, batch_dice, stage,
    ...
    def setup_DA_params(self):
        super(nnUNetTrainerV2_3kid_DP, self).setup_DA_params()
        self.data_aug_params['num_threads'] = 8 * self.num_gpus

    def process_plans(self, plans):
        super(nnUNetTrainerV2_3kid_DP, self).process_plans(plans)
